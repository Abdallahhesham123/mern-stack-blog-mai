...
const sendPost= async(dataToSend ,user_id)=>{

  const results= await requests.addOnePost(dataToSend ,user_id);
  ...
  if(response.ok){
    setNotification({
      ...
      show:true,
      type: 'success',
      text:"Congratulation ,the post has been successfully submitted"
    })
    goToHome();
  }else if(data){
